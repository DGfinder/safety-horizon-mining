(()=>{var e={};e.id=404,e.ids=[404],e.modules={2934:e=>{"use strict";e.exports=require("next/dist/client/components/action-async-storage.external.js")},4580:e=>{"use strict";e.exports=require("next/dist/client/components/request-async-storage.external.js")},5869:e=>{"use strict";e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},399:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},7466:(e,t,n)=>{"use strict";n.r(t),n.d(t,{GlobalError:()=>o.a,__next_app__:()=>h,originalPathname:()=>m,pages:()=>d,routeModule:()=>p,tree:()=>c}),n(7791),n(8840),n(2029),n(5866);var i=n(3191),a=n(8716),r=n(7922),o=n.n(r),s=n(5231),l={};for(let e in s)0>["default","tree","pages","GlobalError","originalPathname","__next_app__","routeModule"].indexOf(e)&&(l[e]=()=>s[e]);n.d(t,l);let c=["",{children:["blog",{children:["__PAGE__",{},{page:[()=>Promise.resolve().then(n.bind(n,7791)),"/mnt/c/Users/HaydenHamilton/Downloads/safety-horizon-mining/src/app/blog/page.tsx"]}]},{layout:[()=>Promise.resolve().then(n.bind(n,8840)),"/mnt/c/Users/HaydenHamilton/Downloads/safety-horizon-mining/src/app/blog/layout.tsx"]}]},{layout:[()=>Promise.resolve().then(n.bind(n,2029)),"/mnt/c/Users/HaydenHamilton/Downloads/safety-horizon-mining/src/app/layout.tsx"],"not-found":[()=>Promise.resolve().then(n.t.bind(n,5866,23)),"next/dist/client/components/not-found-error"]}],d=["/mnt/c/Users/HaydenHamilton/Downloads/safety-horizon-mining/src/app/blog/page.tsx"],m="/blog/page",h={require:n,loadChunk:()=>Promise.resolve()},p=new i.AppPageRouteModule({definition:{kind:a.x.APP_PAGE,page:"/blog/page",pathname:"/blog",bundlePath:"",filename:"",appPaths:[]},userland:{loaderTree:c}})},9264:(e,t,n)=>{Promise.resolve().then(n.bind(n,4908))},5303:()=>{},4908:(e,t,n)=>{"use strict";n.r(t),n.d(t,{default:()=>s});var i=n(326);n(7577);var a=n(4780),r=n(5295);let o=[{slug:"sterile-cockpit-rule-mining-safety",title:'From Cockpit to Haul Truck: How Aviation\'s "Sterile Cockpit" Rule Can Prevent Mining Accidents',excerpt:"Learn how a critical aviation safety rule—the Sterile Cockpit—can be adapted for mining operations to reduce distractions, improve focus, and prevent incidents. A powerful lesson from a 1974 aviation tragedy.",author:"The Crew Resource Mining Team",authorRole:"Aviation Safety Experts",date:"2025-07-22",readTime:"7 min read",category:"Aviation Safety",featured:!0,seo:{metaTitle:'How Aviation\'s "Sterile Cockpit" Rule Can Prevent Mining Accidents',metaDescription:"Learn how a critical aviation safety rule—the Sterile Cockpit—can be adapted for mining operations to reduce distractions, improve focus, and prevent incidents.",keywords:["aviation safety for mining","crew resource management mining","human factors experts","mining safety procedures","non-technical skills mining","sterile cockpit mining","mining distraction prevention","situational awareness mining","aviation mining safety","mining human factors training"],canonicalUrl:"https://crewresourcemining.com.au/blog/sterile-cockpit-rule-mining-safety"},content:`
    ...
    `}],s=()=>{let e=o.find(e=>e.featured)||null,t=o.filter(e=>!e.featured);return(0,i.jsxs)("div",{className:"min-h-screen",children:[i.jsx(a.default,{}),i.jsx("section",{className:"pt-24 pb-16 bg-brand-yellow-50",children:i.jsx("div",{className:"max-w-content mx-auto px-8",children:(0,i.jsxs)("div",{className:"text-center mb-16",children:[i.jsx("h1",{className:"text-4xl md:text-5xl font-bold text-brand-brown-900 mb-6",children:"Safety Insights"}),i.jsx("p",{className:"text-xl text-brand-brown-600 max-w-3xl mx-auto",children:"Aviation-proven safety expertise and insights for mining operations. Learn from airline captains with decades of experience transforming safety cultures."})]})})}),e&&i.jsx("section",{className:"py-16 bg-brand-white",children:(0,i.jsxs)("div",{className:"max-w-content mx-auto px-8",children:[i.jsx("div",{className:"mb-8",children:i.jsx("span",{className:"inline-block bg-brand-orange-500 text-brand-white px-3 py-1 rounded-full text-sm font-semibold",children:"Featured Article"})}),(0,i.jsxs)("div",{className:"grid md:grid-cols-2 gap-12 items-center",children:[(0,i.jsxs)("div",{className:"space-y-6",children:[(0,i.jsxs)("div",{children:[(0,i.jsxs)("span",{className:"text-brand-orange-500 font-semibold text-sm",children:[e.category," • ",e.readTime]}),i.jsx("h2",{className:"text-3xl md:text-4xl font-bold text-brand-brown-900 mt-2 mb-4",children:e.title}),i.jsx("p",{className:"text-brand-brown-600 text-lg leading-relaxed",children:e.excerpt})]}),(0,i.jsxs)("div",{className:"flex items-center justify-between",children:[i.jsx("span",{className:"text-brand-brown-500 text-sm",children:new Date(e.date).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})}),i.jsx("a",{href:`/blog/${e.slug}`,className:"bg-brand-orange-500 text-brand-white px-6 py-3 rounded-lg font-semibold hover:bg-brand-orange-600 transition-colors hover-lift",children:"Read Article →"})]})]}),i.jsx("div",{className:"aspect-w-16 aspect-h-9 bg-brand-yellow-100 rounded-lg overflow-hidden",children:i.jsx("div",{className:"w-full h-full bg-gradient-to-br from-brand-orange-500 to-brand-brown-900 flex items-center justify-center",children:(0,i.jsxs)("div",{className:"text-brand-white text-center p-8",children:[i.jsx("div",{className:"text-6xl mb-4",children:"✈️"}),i.jsx("p",{className:"font-semibold",children:"Aviation Safety Expertise"})]})})})]})]})}),i.jsx("section",{className:"py-16 bg-brand-yellow-50",children:(0,i.jsxs)("div",{className:"max-w-content mx-auto px-8",children:[(0,i.jsxs)("div",{className:"mb-12",children:[i.jsx("h2",{className:"text-3xl font-bold text-brand-brown-900 mb-4",children:"Latest Articles"}),i.jsx("p",{className:"text-brand-brown-600",children:"Expert insights on mining safety, human factors training, and industry best practices."})]}),i.jsx("div",{className:"grid md:grid-cols-2 lg:grid-cols-3 gap-8",children:t.map(e=>(0,i.jsxs)("article",{className:"bg-brand-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow hover-lift",children:[i.jsx("div",{className:"aspect-w-16 aspect-h-9 bg-brand-yellow-100",children:i.jsx("div",{className:"w-full h-48 bg-gradient-to-br from-brand-orange-400 to-brand-brown-800 flex items-center justify-center",children:(0,i.jsxs)("div",{className:"text-brand-white text-center",children:[i.jsx("div",{className:"text-3xl mb-2",children:"⚡"}),i.jsx("p",{className:"text-sm font-medium px-4",children:e.category})]})})}),(0,i.jsxs)("div",{className:"p-6",children:[i.jsx("div",{className:"mb-3",children:(0,i.jsxs)("span",{className:"text-brand-orange-500 font-semibold text-sm",children:[e.category," • ",e.readTime]})}),i.jsx("h3",{className:"text-xl font-bold text-brand-brown-900 mb-3 line-clamp-2",children:e.title}),i.jsx("p",{className:"text-brand-brown-600 text-sm leading-relaxed mb-4 line-clamp-3",children:e.excerpt}),(0,i.jsxs)("div",{className:"flex items-center justify-between",children:[i.jsx("span",{className:"text-brand-brown-500 text-xs",children:new Date(e.date).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"})}),i.jsx("a",{href:`/blog/${e.slug}`,className:"text-brand-orange-500 font-semibold text-sm hover:text-brand-orange-600 transition-colors",children:"Read More →"})]})]})]},e.slug))})]})}),i.jsx("section",{id:"newsletter",className:"py-16 bg-brand-brown-900",children:i.jsx("div",{className:"max-w-content mx-auto px-8 text-center",children:(0,i.jsxs)("div",{className:"max-w-2xl mx-auto",children:[i.jsx("h2",{className:"text-3xl font-bold text-brand-white mb-4",children:"Stay Updated on Mining Safety"}),i.jsx("p",{className:"text-brand-white/80 mb-8",children:"Get weekly insights from aviation safety experts on transforming mining operations. No spam, just valuable safety content."}),(0,i.jsxs)("div",{className:"flex flex-col sm:flex-row gap-4 justify-center",children:[i.jsx("input",{type:"email",placeholder:"your.email@miningcompany.com",className:"px-6 py-3 rounded-lg border-0 text-brand-brown-900 placeholder-brand-brown-500 flex-1 max-w-md"}),i.jsx("button",{onClick:()=>{let e=document.getElementById("newsletter");e&&e.scrollIntoView({behavior:"smooth"})},className:"bg-brand-orange-500 text-brand-white px-8 py-3 rounded-lg font-semibold hover:bg-brand-orange-600 transition-colors whitespace-nowrap hover-lift",children:"Subscribe"})]}),i.jsx("p",{className:"text-brand-white/60 text-sm mt-4",children:"Join 500+ mining professionals receiving our safety insights"})]})})}),i.jsx(r.Z,{})]})}},8840:(e,t,n)=>{"use strict";n.r(t),n.d(t,{default:()=>a,metadata:()=>i});let i={title:"Mining Safety Insights | Aviation-Proven Human Factors Training | Crew Resource Mining",description:"Expert insights on mining safety, human factors training, and aviation-proven strategies for Australian mining operations. Learn from airline captains to improve your safety culture.",keywords:"mining safety insights, human factors mining, aviation safety mining, crew resource management, mining safety culture, FIFO safety training, Australian mining safety",openGraph:{title:"Mining Safety Insights | Crew Resource Mining",description:"Expert insights on mining safety, human factors training, and aviation-proven strategies for Australian mining operations.",type:"website",url:"https://crewresourcemining.com.au/blog",siteName:"Crew Resource Mining",locale:"en_AU"},twitter:{card:"summary_large_image",title:"Mining Safety Insights | Crew Resource Mining",description:"Expert insights on mining safety, human factors training, and aviation-proven strategies for Australian mining operations.",site:"@CrewResourceMining",creator:"@CrewResourceMining"},alternates:{canonical:"https://crewresourcemining.com.au/blog"},robots:{index:!0,follow:!0,googleBot:{index:!0,follow:!0,"max-video-preview":-1,"max-image-preview":"large","max-snippet":-1}}};function a({children:e}){return e}},7791:(e,t,n)=>{"use strict";n.r(t),n.d(t,{default:()=>i});let i=(0,n(8570).createProxy)(String.raw`/mnt/c/Users/HaydenHamilton/Downloads/safety-horizon-mining/src/app/blog/page.tsx#default`)}};var t=require("../../webpack-runtime.js");t.C(e);var n=e=>t(t.s=e),i=t.X(0,[276,326,569],()=>n(7466));module.exports=i})();