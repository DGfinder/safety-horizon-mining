...
If you received this email, your email system is working correctly!
      `});return a.NextResponse.json({success:!0,message:"Test email sent successfully!",emailResult:{id:i.data?.id,timestamp:new Date().toISOString()},config:{from:t,to:r,cc:o,timestamp:new Date().toISOString()}})}catch(t){console.error("Test email failed:",t);let e="Unknown error",s="UNKNOWN";return t.message&&(e=t.message),t.message?.includes("domain")?(s="DOMAIN_NOT_VERIFIED",e="Domain not verified in Resend. Please verify your domain first."):t.message?.includes("API key")?(s="INVALID_API_KEY",e="Invalid Resend API key. Please check your API key."):t.message?.includes("rate limit")&&(s="RATE_LIMITED",e="Rate limited. Please wait before sending another test email."),a.NextResponse.json({success:!1,error:e,errorCode:s,rawError:t.message,config:{from:process.env.FROM_EMAIL,to:process.env.TO_EMAIL,cc:process.env.CC_EMAIL,hasApiKey:!!process.env.RESEND_API_KEY,timestamp:new Date().toISOString()}},{status:500})}}async function c(){let e={hasResendApiKey:!!process.env.RESEND_API_KEY,fromEmail:process.env.FROM_EMAIL||"Not set",toEmail:process.env.TO_EMAIL||"Not set",ccEmail:process.env.CC_EMAIL||"Not set",timestamp:new Date().toISOString()};return a.NextResponse.json({message:"Email configuration check",config:e,ready:e.hasResendApiKey&&process.env.FROM_EMAIL&&process.env.TO_EMAIL})}let l=new o.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/test-email/route",pathname:"/api/test-email",filename:"route",bundlePath:"app/api/test-email/route"},resolvedPagePath:"/mnt/c/Users/HaydenHamilton/Downloads/safety-horizon-mining/src/app/api/test-email/route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:u,staticGenerationAsyncStorage:g,serverHooks:E}=l,d="/api/test-email/route";function y(){return(0,i.patchFetch)({serverHooks:E,staticGenerationAsyncStorage:g})}}};var s=require("../../../webpack-runtime.js");s.C(e);var t=e=>s(s.s=e),r=s.X(0,[276,438],()=>t(6119));module.exports=r})();