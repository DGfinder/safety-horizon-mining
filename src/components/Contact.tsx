          ...
          <div className="bg-white p-8 rounded-lg shadow-lg">
            {!isSubmitted ? (
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <h3 className="text-2xl font-bold text-navy mb-6">Book Your Discovery Call</h3>
                </div>
                ...
                <button
                  type="submit"
                  className="w-full bg-orange text-white py-4 rounded-lg font-semibold text-lg hover:bg-orange/90 transition-colors hover-lift"
                >
                  Book Discovery Call →
                </button>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm">Quick evaluation of your current human factors program</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-orange rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    ...
                    <p className="text-white/80 text-sm">Specific solutions for your operation's unique challenges</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-orange rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    ...
                    <p className="text-white/80 text-sm">Estimated impact on incident reduction and cost savings</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <span className="ml-2 text-muted-foreground">+61 8 9000 0000</span>
                </div>
                <div>
                  <span className="font-semibold text-navy">Email:</span>
                  <span className="ml-2 text-muted-foreground">contact@crmmining.com.au</span>
                </div>
                <div>
                  <span className="font-semibold text-navy">Location:</span>
                  <span className="ml-2 text-muted-foreground">Perth, Western Australia</span>
                </div>
              </div>
            </div>
          </div>
