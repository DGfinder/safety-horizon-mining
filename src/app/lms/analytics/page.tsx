...
export default async function AnalyticsPage() {
  const { user, enrollmentData } = await getAnalyticsData()
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-[#192135] flex items-center gap-3">
            <BarChart3 className="w-8 h-8 text-[#EC5C29]" />
            Performance Analytics
          </h1>
          <p className="text-slate-600 mt-1">Track your learning progress and performance metrics</p>
        </div>
